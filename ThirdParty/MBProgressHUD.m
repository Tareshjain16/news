...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        [self addGestureOnCurrentView];
        
	}
	return self;
}
- (void)addGestureOnCurrentView
{
   __autoreleasing UITapGestureRecognizer *gesture = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(tapOnHud)];
